...
const convertHandle = () => {
    ...
    if(input.value == "ConvertAll"){
        ...
        PythonShell('convertAllArchives.py', opcoes, function (err, results){
            if(err){
                openModal(err)
            }else{
        ...
        PythonShell('convertOnlyPdf.py', opcoes, function (err, results){
            if(err){
                openModal(err)
            }else{
                arrowSpin.classList.remove("spinner")
        ...
        PythonShell('convertOnlyDocx.py', opcoes, function (err, results){
            if(err){
                openModal(err)
            }else{
                arrowSpin.classList.remove("spinner")
...
document.getElementById("buttonConvert").addEventListener("click", convertHandle);
